...
<div class="justify-center max-w-sm w-full lg:max-w-full lg:flex mt-4">
  <div class="border border-gray-300 bg-white rounded p-4 flex flex-col leading-normal">
    ...
    <h3 class="font-bold text-lg text-gray-800 mb-1">Create new Group</h3>
    <hr/>
    ...
    <form action="{{ route('group.store') }}" method="POST">
      ...
      <div class="mt-3 mb-5">
        ...
        <x-input-text :name="'name'" :placeholder="'Enter your name'"/>
        @error('name')
      ...
      <div class="mb-5">
        ...
        <x-input-text :name="'description'" :placeholder="'Enter your description'"/>
      </div>
      
      <div class="mb-5">
        <x-label :for="'isActive'">Is active</x-label>
        <x-input-radio :name="'isActive'" :value="'N'" :checked="'N'">N</x-input-radio>
        <x-input-radio :name="'isActive'" :value="'Y'">Y</x-input-radio>
      </div>
